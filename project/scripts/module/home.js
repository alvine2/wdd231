...
const myLat = "0.3476";     // Uganda (Kampala)
const myLon = "32.5825";
    ...
    const displayResults = (data) => {
        ...
        eventMainBox.innerHTML = `
            <div class="current-weather">
                <h4><span id="city-name">${data.name}</span></h4>
                <h5>Temp: <span id="current-temp">${parseFloat(data.main.temp).toFixed(0)}&deg;F</span> <br><span>${weekdays[day]}</span></h5>
                <figure>
